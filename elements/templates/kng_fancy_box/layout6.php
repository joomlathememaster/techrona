...
$widget->add_render_attribute( 'single_wrap', 'class', 'kng-fancybox relative '.implode(' ', $text_align));
...
$widget->add_render_attribute( 'fb_link', 'class', 'kng-readmore d-inline-block' );
...
<div <?php kng_print_html($widget->get_render_attribute_string('single_wrap'));?>>
    <div class="d-flex gutters-30 justify-content-between">
        ...
        <div class="kng-link-more col-auto">
            <a <?php echo implode( ' ', [ $link_attributes ] );?>><span class="kngi-arrow-right-solid"></span></a>
        </div>
        <?php endif; ?>
    </div>   
</div>
