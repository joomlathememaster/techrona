...
$widget->add_render_attribute( 'icon-wrap', 'class', 'kng-fancy-icon-wrap relative kng-transition');

?>
 
<div <?php kng_print_html($widget->get_render_attribute_string('single_wrap'));?>>
    <div class="fancy-inner text-center">
        ...
        <div class="kng-fancybox-content kng-transition">
