...
$load_more = array(
    ...
    'gap'                        => $settings['gap'] != '0' ? $widget->get_setting('gap', '30') : '0',
    ...
    // Read more
    'show_readmore'              => $widget->get_setting('show_readmore', ''),
...
// Render Attribute
// Grid
$masonry_mode = $widget->get_setting('masonry_mode', '');
