...
$widget->add_render_attribute( 'counter', [
    'class' => 'kng-counter-number-wrap text-'.$widget->get_setting('number_color','heading')
] );
...
<div <?php kng_print_html($widget->get_render_attribute_string( 'wrap' ));?>>
    <div class="kng-row-wrap row gutters-0 justify-content-center">
        ...
        <div class="kng-count-content col-auto">
