...
$args = [
    'slide_to_show_widescreen'   => $widget->get_setting('slide_to_show_widescreen', '5'),
    'slide_to_show'              => $widget->get_setting('slide_to_show', '5'),
    'slide_to_show_laptop'       => $widget->get_setting('slide_to_show_laptop', '4'),
    'slide_to_show_tablet_extra' => $widget->get_setting('slide_to_show_tablet_extra', '4'),
