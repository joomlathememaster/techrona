    ...
    <form role="search" method="get" class="search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
        <div class="kng-search-inner d-flex gutters-10 gutters-grid">
            <div class="col-12 col-sm-auto">
                ...
                <button type="submit" class="search-submit-xs d-sm-none" value=""><span class="kngi-search-400"></span></button>
            </div>
            <div class="col-12 col-sm-auto d-none d-sm-block">
                <button type="submit" class="search-submit" value=""><?php echo esc_html__( 'Search Now', 'techrona' ) ?><span class="kng-icon kngi-arrow-right-solid"></span></button>
            </div>
        </div>
    </form>
</div>
