...
$logo_aligns = techrona_get_class_breakpoints($settings, [
    'prefix' => 'logo_align',
...
if(!empty($logo['id'])) : ?>
    <div class="kng-logo d-flex align-items-center <?php echo esc_attr(implode(' ', $logo_aligns)) ?> <?php echo esc_attr($kng_animate); ?>">
        <?php if ( ! empty( $logo_link['url'] ) ) { ?><a <?php kng_print_html($widget->get_render_attribute_string( 'logo_link' )); ?>><?php } ?>
